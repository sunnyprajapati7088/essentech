    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="<?php echo e(($i % 4) * 0.1 + 0.1); ?>s">
                <a href="<?php echo e(route('brands.show', $brand['slug'])); ?>" style="text-decoration:none;">
                    <div class="brand-card">
                        <?php if(!empty($brand['logo'])): ?>
                            ...
                            <div class="brand-logo-circle" style="background:<?php echo e($brand['color']); ?>;color:<?php echo e($brand['text']); ?>;display:none;">
                                <?php echo e(strtoupper(substr($brand['name'], 0, 2))); ?>

                            </div>
                        <?php else: ?>
                            <div class="brand-logo-circle" style="background:<?php echo e($brand['color']); ?>;color:<?php echo e($brand['text']); ?>;">
                                <?php echo e(strtoupper(substr($brand['name'], 0, 2))); ?>

                            </div>
                        <?php endif; ?>
                        <h3><?php echo e($brand['name']); ?></h3>
                        <p><?php echo e($brand['desc']); ?></p>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="bg-primary rounded-4 p-4 p-md-5 text-white">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-light btn-lg fw-bold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\OneDrive\Desktop\essentechs\essentechs\resources\views/brands/index.blade.php ENDPATH**/ ?>