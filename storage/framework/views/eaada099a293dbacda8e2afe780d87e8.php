...
<head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('title', 'EssenTechs - AC Repair Website'); ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Best AC repair and home appliance services.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'AC repair, appliance service, refrigerator repair, washing machine repair'); ?>">
...
<body>
    ...
    <!-- Header Start -->
    <?php echo $__env->make('common.landing-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- Header End -->
    ...
    <!-- Footer Start -->
    <?php echo $__env->make('common.landing-footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- Footer End -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/essentechs/resources/views/layouts/landing-page.blade.php ENDPATH**/ ?>