    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto pe-4 py-3 py-lg-0">
            ...
            <a href="<?php echo e(route('brands.index')); ?>"
                class="nav-item nav-link <?php echo e(request()->routeIs('brands.*') ? 'active' : ''); ?>">
                Repair by Brand
            </a>
            <a href="<?php echo e(route('blog')); ?>"
                class="nav-item nav-link <?php echo e(request()->routeIs('blog*') ? 'active' : ''); ?>">
                Blog
            </a>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\Desktop\essentechs\essentechs\resources\views/common/header.blade.php ENDPATH**/ ?>