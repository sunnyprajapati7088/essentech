...
<?php $__env->startSection('content'); ?>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex align-items-center carousel-content-row justify-content-center">
                        <div class="container">
                            <?php echo $__env->make('common.common-carousel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </div>
    ...
    <!-- Facts Start -->
    <div class="container-fluid facts my-5 py-5" data-parallax="scroll" data-image-src="<?php echo e(asset('img/carousel-1.jpg')); ?>">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="<?php echo e(route('installationUninstallation')); ?>">Installation &
...
<?php echo $__env->make('layouts.landing-page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/essentechs/resources/views/landing-page.blade.php ENDPATH**/ ?>